...
testsample <- irs(design=list(None=list(panel=c(PanelOne=10), over=0,
...
testsample <- irs(design=list("LAKE/POND"=list(panel=c(PanelOne=10), over=6,
...
testsample <- irs(design=list("A"=list(panel=c(PanelOne=10), over=6,
...
testsample <- irs(design=list("< 100 SQ.Kilometers"=list(panel=c(PanelOne=16),
