...
test_that("Categorical: Unstratified single-stage analysis", {
...
test_that("Categorical: Stratified single-stage analysis", {
  expect_true(exists("Condition_Estimates"))
  expect_equal(attributes(Condition_Estimates)$class, "data.frame")
  expect_equal(nrow(Condition_Estimates), 9)
})
...
test_that("Categorical: Unstratified two-stage analysis", {
  expect_true(exists("Condition_Estimates"))
  expect_equal(attributes(Condition_Estimates)$class, "data.frame")
  expect_equal(nrow(Condition_Estimates), 9)
})
...
test_that("Categorical: Stratified two-stage analysis", {
  expect_true(exists("Condition_Estimates"))
  expect_equal(attributes(Condition_Estimates)$class, "data.frame")
  expect_equal(nrow(Condition_Estimates), 9)
})
...
# Perform tests
CDF_Estimates <- cont_analysis(dframe = dframe, vars = vars,
  subpops = subpops, siteID = "SITE_ID", weight = "WGT_TP", xcoord = "XCOORD",
  ycoord = "YCOORD")
