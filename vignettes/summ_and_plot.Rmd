...
The `NLA_West` data in spsurvey is a design frame as an `sf` object that contains lakes from California, Oregon and Washington sampled in an NLA study. There are eight variables in `NLA_West`:
