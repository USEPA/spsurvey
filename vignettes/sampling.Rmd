...
The `key.width` argument extends the plot's margin to fit the legend text nicely within the plot. The `sp_plot()` can equivalently be used in place of `plot()` (`sp_plot()` is currently maintained for backwards compatibility with previous spsurvey versions).
