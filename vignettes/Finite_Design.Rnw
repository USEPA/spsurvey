...
For this survey design, a shapefile will be used as the sampling frame.  The sf package function st\_write is used to create the shapefile.  The following arguments are included in the call to grts: (1) design: assigned the Paneldsgn list; (2) DesignID: assigned the value "UNEQUAL"; (3) type.frame: assigned the value "finite"; (4) src.frame: assigned the value "shapefile"; (5) in.shape: assigned the value "NE\_lakes"; (6) mdcaty: assigned the value "Area\_cat"; and (7) shapefile: assigned the value FALSE.  Upon completion of the call to grts, the initial six sites for the survey design and a design summary are printed.
