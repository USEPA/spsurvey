...
You will be plotting several side-by-side plots of populatoin sites and sampled sites.  To have R properly display the plots side-by-side, specify this in the global plotting options by running:
```{r}
par(mfrow = c(1, 2), pch = 19)
```
You can reset these any global plotting options by running `dev.off()`.
...
You will also save the bounding box of coordinates from the data. This will be useful when plotting later.
...
plot(st_coordinates(NLA_2007),
     pch = 19, 
     xlim = c(xmin, xmax), 
     ylim = c(ymin, ymax))
title("Population Sites", 
      adj = 0)
plot(st_coordinates(eqprob$sites.base), 
     pch = 19, 
     xlim = c(xmin, xmax), 
     ylim = c(ymin, ymax))
title("Sampled Sites", 
...
To plot the population sites next to the sampled sites, run:
```{r, fig.show = "hold", out.width = "50%"}
plot(st_coordinates(subset(NLA_2007, Lake_Origin == "Man-Made")), 
     xaxt = "n", 
     yaxt = "n",
     pch = 19,
     xlim = c(xmin, xmax),
     ylim = c(ymin, ymax))
points(st_coordinates(subset(NLA_2007, Lake_Origin == "Natural")), 
       col = "orange",
       pch = 19)
title("Population Sites",
      adj = 0)
legend(x = "topright", 
       legend = c("Man-Made", "Natural"), 
       col = c("black", "orange"), 
       pch = 19, 
       inset = c(0,-0.25), 
       xpd = TRUE, 
       cex = 1.15)
plot(st_coordinates(subset(uneqprob$sites.base, Lake_Origin == "Man-Made")), 
     xaxt = "n", 
     yaxt = "n", 
     pch = 19,
     xlim = c(xmin, xmax),
     ylim = c(ymin, ymax))
points(st_coordinates(subset(uneqprob$sites.base, Lake_Origin == "Natural")), 
       col = "orange", 
       pch = 19)
title("Sampled Sites",
      adj = 0)
...
plot(st_coordinates(subset(NLA_2007, Lake_Origin == "Man-Made")), 
     ...
     xlim = c(xmin, xmax),
     ylim = c(ymin, ymax))
points(st_coordinates(subset(uneqprob$sites.base, Lake_Origin == "Man-Made")), 
       pch = 19)
title("Man-Made Lakes",
      adj = 0)
legend(x = "topright", 
       legend = c("Population Lakes", "Sampled Lakes"), 
       pch = c(1, 19), 
       inset = c(0,-0.25), 
       xpd = TRUE, 
       cex = 1.15)
plot(st_coordinates(subset(NLA_2007, Lake_Origin == "Natural")), 
     xaxt = "n", 
     yaxt = "n", 
     pch = 1,
     xlim = c(xmin, xmax),
...
```{r, fig.show = "hold", out.width = "50%", error = TRUE}
plot(st_geometry(NLA_2007))
points(st_coordinates(propprob$sites.base), pch = 19)

plot(st_geometry(NLA_2007))
plot(st_coordinates(propprob$sites.base), pch = 19)

plot(st_geometry(NLA_2007))
plot(st_geometry(propprob$sites.base), pch = 19, add = TRUE)
...
```{r}
#aspect ratio gets all messed up
plot(NLA_2007["Lake_Origin"], key.pos = 1)
plot(strat_eqprob$sites.base["stratum"], pch = 19, add = TRUE)

#aspect ratio gets all messed up
plot(NLA_2007["Lake_Origin"], key.pos = 1, rest = FALSE)
plot(strat_eqprob$sites.base["stratum"], pch = 19, add = TRUE, reset = FALSE)

#aspect ratio gets all messed up
plot(NLA_2007["Lake_Origin"], key.pos = 1, reset = FALSE)
plot(strat_eqprob$sites.base["stratum"], pch = 19, add = TRUE)
...
```{r, fig.show = "hold", out.width = "50%"}
plot((subset(NLA_2007, Lake_Origin == "Man-Made"))["Chla_cond"], key.pos = 1)
plot(subset(strat_uneqprob$sites.base, Lake_Origin == "Man-Made")["Chla_cond"], pch = 19, add = TRUE)
```
...
plot(st_coordinates(subset(NLA_2007, Lake_Origin == "Man-Made" & 
     ...
     xlim = c(xmin, xmax),
     ylim = c(ymin, ymax))
points(st_coordinates(subset(NLA_2007, Lake_Origin == "Natural" & Chla_cond == "Good")), 
       col = "orange", 
       pch = 19)
points(st_coordinates(subset(NLA_2007, Lake_Origin == "Man-Made" & Chla_cond == "Poor")), 
       col = "green", 
       pch = 19)
points(st_coordinates(subset(NLA_2007, Lake_Origin == "Natural" & Chla_cond == "Poor")), 
       col = "blue", 
       pch = 19)
title("Population Sites",
      adj = 0)
legend(x = "topright", 
       legend = c("Man-Made, Good", "Natural, Good", "Man-Made, Poor", "Natural, Poor"), 
       col = c("black", "orange", "green", "blue"), 
       pch = 19, 
       inset = c(0,-0.25), 
       xpd = TRUE, 
       cex = 1.15)
...
plot(st_coordinates(subset(strat_uneqprob$sites.base, Lake_Origin == "Man-Made" & 
                           Chla_cond == "Good")),
     xaxt = "n", 
     yaxt = "n", 
     pch = 19,
     xlim = c(xmin, xmax),
     ylim = c(ymin, ymax))
points(st_coordinates(subset(strat_uneqprob$sites.base, Lake_Origin == "Natural" & Chla_cond == "Good")), 
       col = "orange", 
       pch = 19)
points(st_coordinates(subset(strat_uneqprob$sites.base, Lake_Origin == "Man-Made" & Chla_cond == "Poor")), 
       col = "green", 
       pch = 19)
points(st_coordinates(subset(strat_uneqprob$sites.base, Lake_Origin == "Natural" & Chla_cond == "Poor")), 
       col = "blue", 
       pch = 19)
title("Sampled Sites",
      adj = 0)
...
points(st_coordinates(subset(NLA_2007, Lake_Origin == "Natural" & Chla_cond == "Good")), 
       col = "orange", 
       pch = 19)
title("Population Sites - Good Chla_cond",
      adj = 0)
legend(x = "topright", 
       legend = c("Man-Made", "Natural"), 
       col = c("black", "orange"), 
...
points(st_coordinates(subset(strat_uneqprob$sites.base, Lake_Origin == "Natural" & Chla_cond == "Good")), 
       col = "orange", 
       pch = 19)
title("Sampled Sites - Good Chla_cond",
      adj = 0)
legend(x = "topright", 
       legend = c("Man-Made", "Natural"), 
       col = c("black", "orange"), 
