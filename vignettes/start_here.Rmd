...
If you want to replicate the exact results in any of these vignettes at a later time, you will need to set a "seed" just after the `library(spsurvey)` statement. To set this seed, run:
```{r}
set.seed(42)
```
