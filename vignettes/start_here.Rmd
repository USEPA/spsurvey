...
These vignettes cover some of the core functions in spsurvey and the core arguments within those functions. These vignettes do not cover all of the functions in spsurvey or all of the arguments within the core functions. To learn more about features of spsurvey that are not covered in these vignettes, we encourage you read spsurvey's documentation. Interactive help files for a particular function are available by running `?function_name` after loading spsurvey. For example, to learn more about the `grts()` function, run `?grts`.
