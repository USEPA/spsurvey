...
```{r, include = FALSE}
# use nla_2007 for analysis, NE_lakes for design
# use 
...
library(devtools)
load_all()
load("C:/Users/mdumelle/Documents/software/spsurvey/spsurvey/data/NLA_2007.rda")
NLA_2007 <- NLA_2007 %>% select(siteID:ycoord, Lake_Origin, Chla, Chla_cond, NTL)
```
...
```{r}
eqprob_chla <- cont_analysis(dframe = eqprob_base,  vars = "Chla", siteID = "siteID",
                                weight = "wgt", xcoord = "X", 
                                ycoord = "Y")
```
