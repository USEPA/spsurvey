...
You can move between coordinate systems using `sf::st_transform()`. We can transform `NE_Lakes_geo`, which uses geographic coordinates, to `NE_Lakes`, which uses projected coordinates, by running
```{r}
