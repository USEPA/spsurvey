...
You can move between coordinate systems using `sf::st_transform()`. For example, we can transform from projected to geographic (latitude and longitude) coordinates  in `NE_Lakes`by running
```{r}
