...
1. Summarizing and Visualizing Data: Use the `summary()` and `plot()` functions to summarize and visualize sample frames and samples. To view this vignette, run `vignette("EDA", "spsurvey")` (EDA is short for exploratory data analysis).
...
The spsurvey version 5.0 update implemented many significant changes to existing functions. As a result, some of your old code may not run properly while using version 5.0. Though we recommend adapting your code to work with the version 5.0, you may also install a previous version of spsurvey. For information regarding the installation of previous version of R packages, please visit the RStudio support page [here](https://support.rstudio.com/hc/en-us/articles/219949047-Installing-older-versions-of-packages). Additionally, old versions of spsurvey are also available for download in the release tags section of our GitHub repository [here](https://github.com/USEPA/spsurvey/releases).
