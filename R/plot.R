...
#' will be of the distributions of the right-hand side variables. If the left-hand side
#' of the variable contains a variable, plots will be of the left-hand size variable
