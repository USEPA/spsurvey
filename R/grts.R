...
#' @examples
#' \dontrun{
#'   test_sample <- grts(sframe = "test_sf", n_samp = 100)
#' }
#'
#' @export
#################################################################################

grts <- function(sframe, n_samp, stratum = NULL, seltype = "equal", wgt_units = NULL,
  ...
  dsgn <- list(stratum_var = stratum_var, caty_var = caty_var, aux_var = aux_var,
               ...
               wgt_units = wgt_units, seltype = NULL, n_samp = NULL, caty_n = NULL, 
