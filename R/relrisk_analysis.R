...
#' categorical data generated by a probability survey.  Relative risk measures
#' the strength of association between stressor and response variables that can
#' be classified as either good (i.e., reference condition) or poor (i.e.,
#' different from reference condition).  The input data argument, dframe, can be
...
#'       data}
#'     \item{\code{relrisk_var}}{calculate values required for estimating
