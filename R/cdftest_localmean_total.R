...
#'   \describe{
#'     \item{\code{cdftestvar_total}}{calculates variance-covariance estimates
#'       of the estimated totals (cell totals, row totals, column totals, and
#'       grand total) of a contingency table}
#'   }
#'
