...
# with over.n
Equalsites <- grtspts(sframe = sframe, nsamp = 100, over.n = 10)
plot(st_geometry(sframe), pch = "+")
plot(st_geometry(Equalsites$sites.base), pch = 16, col = 'red', add = TRUE)
plot(st_geometry(Equalsites$sites.over), pch = 16, col = 'blue', add = TRUE)

# with over.near
Equalsites <- grtspts(sframe = sframe, nsamp = 100, over.near = 5)
plot(st_geometry(sframe), pch = "+")
...
# get error with this
set.seed(291829)
Equalsites <- grtspts(sframe = sframe, pt_density = 1/10000, nsamp = 10)
...
# mindis option
set.seed(291829)
Equalsites <- grtspts(sframe = sframe, pt_density = 1/10000, mindis = 10000, nsamp = 10)
